...
<button type="submit" class=" w-100 btn btn-primary">Submit</button>
          ...
          <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <form class="user" method="POST" action="userlogin.php">
                    <div class="form-group row" method="post">
          <div class="col-sm-6 mb-3 mb-sm-0">
                        <input
                          type="email"
        ...
        </div> <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">...</div>
        </div>
...
$selectquery="SELECT categorytype FROM categories where id=11 ";
$query=mysqli_query($conn,$selectquery);
$num=mysqli_num_rows($query);
while($res=mysqli_fetch_array($query)){  
    ?>
        <h3 ><?php echo $res['categorytype'];?></h3>
        <?php
}
?>
...
include 'admin/inc/connect.php';
// $pname= $_GET['pname'];
$selectquery="SELECT * FROM addproducts where category='women'";
$query=mysqli_query($conn,$selectquery);
$num=mysqli_num_rows($query);
while($res=mysqli_fetch_array($query)){
    ...
    ?> 
     <div class="col-lg-4 col-6">
       <div class="card border-0">
               <a href="productdetails.php?proname= '<?php echo $res['pname'];?>'"> <img src="<?php echo  "admin/img/". $res['pic'];?>" width="100%" height="143px" alt="image"></a>
              <div class="card-body p-0">
                <a class="product-meta text-decoration-none small d-block pb-1 text-muted"><?php echo $res['category'];?></a>
                
                <h6  class=" fs-sm"><?php echo $res['pname'];?></h6 >
                <div class="d-flex border-bottom py2 justify-content-between">
                  <div class="product-rate">
                  <span class="text-accent">$<?php echo $res['price'];?><small>.99</small>
                  </span>
                </div>
...
<div class="container">
  <div class="row mt-5">
    ...
    <?php 
include 'admin/inc/connect.php';
$selectquery="SELECT * FROM addproducts where category='mens'";
$query=mysqli_query($conn,$selectquery);
$num=mysqli_num_rows($query);
while($res=mysqli_fetch_array($query)){
    ...
    ?> 
     <div class="col-lg-4 col-6">
       <div class="card border-0">
              <a href="admin/productdetails.php" class="text-decoration-none"> <img src="<?php echo  "admin/img/". $res['pic'];?>" width="100%" alt="image"></a> 
              <div class="card-body p-0">
                <a class="product-meta text-decoration-none small d-block pb-1 text-muted"><?php echo $res['category'];?></a>
