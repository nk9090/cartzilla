...
while($res=mysqli_fetch_array($query)){
    ...
    <td><?php echo $res['pdname'];?></a></td>
    <td><?php echo $res['ip_address'];?></td>

   
    
    
<td><form action="updtcart.php" method="POST">
  <input type="hidden" name="id" value="<?php echo $res['id']; ?>">
    <input name="quantity"  type="number"class="text-center quantity" value="<?php echo $res['quantity'];?>" min="1" max="10"></td>
